...
namespace UIAutomation.Utils_Misc
{
    ...
    public class Environment
    {
        ...
        private static Dictionary<string, string> ReadEnvConfig()
        {
            ...
            // Check and get Descendants of the specific ENV
            ...
            //Get APIToken
            configData.Add("config:apikey", config.Descendants("API").FirstOrDefault()?.Attribute("key").Value);
            configData.Add("config:apiurl", config.Descendants("API").FirstOrDefault()?.Attribute("url").Value);
            //Get Email ExchangeInfo
            configData.Add("config_mail:username", configXml.Descendants("EmailExchangeServerInformation").FirstOrDefault()?.Attribute("username").Value);
            configData.Add("config_mail:password", configXml.Descendants("EmailExchangeServerInformation").FirstOrDefault()?.Attribute("encryptedPassword").Value);
