...
namespace UIAutomation.Utils_Misc
{
    class Data
    {
        ...
        public static string Get(string key, string defaultValue = null)
        {
            ...
            if (testData == null) throw new InvalidDataException($"Test data not found; key [{key}]");
        ...
        // Used to extract the 1st regular expression match. Return empty on no result
        public static string GetReularExpressionValue(string value, string pattern)
        {
